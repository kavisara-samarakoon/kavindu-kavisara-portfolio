...
const projectVisuals = {
  ...
  nexora: {
    ...
    imageAlt: "NEXORA game deals and giveaways platform cover",
  ...
  "pfsense-firewall-lab": {
    gradient: "from-accent/15 via-accent/5 to-transparent",
    imageSrc: "/images/projects/pfsense-firewall-lab/cover.png",
    imageAlt: "pfSense firewall and network security lab cover",
  ...
  "freebsd-asterisk-voip": {
    gradient: "from-accent/15 via-accent/5 to-transparent",
    imageSrc: "/images/projects/freebsd-asterisk-voip/cover.png",
    imageAlt: "FreeBSD and Asterisk VoIP configuration lab cover",
  ...
  unimatelk: {
    gradient: "from-accent/15 via-accent/5 to-transparent",
    imageSrc: "/images/projects/unimatelk/cover.png",
    imageAlt: "UniMateLK student academic platform project cover",
  ...
  "personal-portfolio": {
    ...
    imageSrc: "/images/projects/personal-portfolio/cover.png",
    imageAlt: "Personal portfolio website project cover",
